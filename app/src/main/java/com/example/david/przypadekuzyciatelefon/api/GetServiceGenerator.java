...
/**
 * Klasa odpowiedzialna za odbiór danych z API
 */

public class GetServiceGenerator {
    /**
     * Tworzenie obiektu przetwarzającego format JSON na odbieralny przez androida
     */
